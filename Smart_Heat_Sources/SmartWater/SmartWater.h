...
#define ZCL_USING_ON_OFF_CLUSTER_ON_OFF_CLUSTER_REPORTING_STATUS_SERVER_ATTRIBUTE 
...
#define EMBER_AF_PLUGIN_BUTTON_INTERFACE_BUTTON_TIMEOUT_MS 3000
...
#define EMBER_AF_PLUGIN_FIND_AND_BIND_TARGET_COMMISSIONING_TIME 15
